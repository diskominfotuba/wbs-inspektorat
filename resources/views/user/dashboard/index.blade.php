                    ...
                    <div class="d-flex row">
                        <div class="col-sm-12">
                            <div class="card-body">
                                ...
                                <p class="mb-4">
                                    Hallo Budi, pantau aktifitas pengaduanmu di sini.
                                </p>
                                <a href="{{ route('user.pengaduan') }}" class="btn btn-primary">Lihat Semua Pengaduan</a>
                                <a href="{{ route('user.pengaduan.create') }}" class="btn btn-info">Buat Pengaduan</a>
                            </div>
                        </div>
                    </div>
                </div>
